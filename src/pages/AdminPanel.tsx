    ...
    <div className="mx-auto flex min-h-screen w-full max-w-[390px] flex-col bg-[#faf6f8]">
      ...
      <div className="mx-6 mb-4 mt-2 flex gap-3">
        <div className="flex flex-1 flex-col items-center rounded-2xl bg-white py-4 shadow-sm">
          <span className="font-serif text-[26px] text-[#2d2d2b]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
            {guests.length}
          </span>
        ...
        <div className="flex flex-1 flex-col items-center rounded-2xl bg-white py-4 shadow-sm">
          <span className="font-serif text-[26px] text-[#5a7a50]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
            {coming}
          </span>
          <span className="mt-0.5 font-sans text-[9px] uppercase tracking-[2px] text-[#8e8574]">
            Կգա
        ...
        <div className="flex flex-1 flex-col items-center rounded-2xl bg-white py-4 shadow-sm">
          <span className="font-serif text-[26px] text-[#b85c5c]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
            {notComing}
          </span>
          <span className="mt-0.5 font-sans text-[9px] uppercase tracking-[2px] text-[#8e8574]">
            Չի գա
